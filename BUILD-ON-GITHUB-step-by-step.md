...
- **Add meetings to your iPhone/Mac Calendar:** first, in **Settings → Calendar & invites**, enter your **calendar invite email** (the personal Gmail you want events tagged with) — it's stored encrypted in your vault, never on GitHub. Then, whenever you save a new future meeting, the app hands iOS a calendar file — tap **“Add to Calendar”** and it's in your iPhone Calendar (syncing on to your other calendars). Each meeting also has **📅 Add to calendar** and **Google** buttons to add it manually or after a reschedule. You can turn the auto-add off in Settings. *(Note: a secure static page can't silently send server emails; this .ics method is the standard, private way to get events onto your devices.)*
